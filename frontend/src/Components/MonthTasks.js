...
export default function MonthTasks(props) {
...
//   return (
//     <Card sx={{ width:"30%",maxWidth: 400 ,margin:"15px"}}>
...
//       <Divider sx={{width:"90%",margin:"auto"}}/>
//       <CardActions sx={{position:"relative"}}>
//         <div style={{width:"10px",margin:"5px 10px"}}><TaskAltIcon/></div>
//         <div style={{width:"10px",margin:"5px 10px"}}><DeleteOutlineIcon/></div>
//         <div style={{position:"absolute",right:"0",marginRight:"15px"}}>11th Dec</div>
//       </CardActions>
//     </Card>
//   );
// }